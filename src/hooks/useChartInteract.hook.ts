...
export const useChartInteract = (
  ...
  console.log("fnOnEvent.length:",fnOnEvent.length)
  ...
  fnOnEvent.forEach(item => {
    ...
    console.log("chartEditStore.requestGlobalConfig.requestDataPond:",chartEditStore.requestGlobalConfig.requestDataPond)
    console.log("globalConfigPindAprndex",globalConfigPindAprndex)
    if (globalConfigPindAprndex !== -1) {
      ...
      console.log("item.interactComponentId",item.interactComponentId)
